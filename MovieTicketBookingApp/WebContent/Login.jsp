...
<header class="w3-display-container w3-content" style="max-width:1500px;">
  <img class="w3-image" src="images/login.PNG" alt="The Hotel" style="min-width:1000px" width="1500" height="800">
  <div class="w3-display-topleft w3-padding w3-col l6 m8">
    ...
    <div class="w3-container w3-white w3-padding-16">
      <form action="LoginInt.jsp" method = "POST">
        ...
        <button class="w3-button w3-dark-grey" type="submit">Login <br/>${errorMsg}</button>
      </form>
    </div>
  </div>
</header>
